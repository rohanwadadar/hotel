...
if (isset($_POST['selected_rooms'], $_POST['start_date'], $_POST['end_date'])) {
    ...
    <div class="container">
        ...
        <form action="login1.php" method="post"> <!-- Changed action to booking_form.php -->
            ...
            <button type="submit" class="btn btn-primary btn-block">please register your account</button>
        </form>
    </div>
    </body>
    </html>
